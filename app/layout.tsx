...
export const metadata: Metadata = {
  ...
  description: 'Writing code & playing games. Building interfaces for productivity and gaming.',
  keywords: ['Software Engineer', 'Game Development', 'Web Developer', 'Portfolio', 'React', 'Gaming'],
